...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'user': '2000/hour',  # Increased from default
        'ml_analysis': '500/hour',  # Increased from 100
        'batch_analysis': '50/hour',  # Increased from 10
        'health_check': '1000/hour',  # Increased from 200
    },
